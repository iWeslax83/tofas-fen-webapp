                  ...
                  <div className="card-content">
                    ...
                    <div className="card-meta">
                      <div className="meta-item">
                        ...
                        <span>Yayın Tarihi: {new Date(announcement.date).toLocaleDateString('tr-TR')}</span>
                      </div>
                      {announcement.expire && (
                        <div className="meta-item">
                          <Calendar className="meta-icon" />
            ...
            <div className="modal">
              ...
              <form onSubmit={async (e) => {
                ...
                <div className="form-group">
                  ...
                  <input name="title" className="form-input" required placeholder="Duyuru başlığını giriniz" />
                </div>
                <div className="form-group">
                  <label className="form-label">Duyuru İçeriği</label>
                  <textarea name="content" className="form-textarea" rows={6} required placeholder="Duyuru içeriğini detaylıca yazınız" />
                </div>
                <div className="form-group">
