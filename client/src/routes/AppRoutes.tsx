...
// F-H5: per-route ErrorBoundary. A render error in one page used to nuke the
// whole shell because the ErrorBoundary was at app root. Keying the boundary
// on pathname means each navigation spins up a fresh boundary, so a crash on
// /admin/notes doesn't prevent the user from navigating away to /admin/home.
function RouteBoundary({ children }: { children: React.ReactNode }) {
  const location = useLocation();
  return <EnhancedErrorBoundary key={location.pathname}>{children}</EnhancedErrorBoundary>;
}
      ...
      <RouteBoundary>
        <Suspense fallback={<LoadingSpinner />}>
          <Routes>
            ...
            />
            <Route
              path="/admin/dilekce-listesi"
              element={
                <ProtectedRoute allowedRoles={['admin']}>
                  <AdminDilekceListPage />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              path="/admin/yeni-kayit-basvurulari"
              element={
                <ProtectedRoute allowedRoles={['admin']}>
            ...
            />
            <Route
              path="/admin/randevu-basvurulari"
              element={
                <ProtectedRoute allowedRoles={['admin']}>
            ...
            />
            <Route
              path="/ziyaretci/sohbet"
              element={
                <ProtectedRoute allowedRoles={['ziyaretci']}>
                  <VisitorChatPage />
                </ProtectedRoute>
              }
            />
            <Route
              path="/ziyaretci/randevu"
              element={
                <ProtectedRoute allowedRoles={['ziyaretci']}>
                  <VisitorAppointmentPage />
                </ProtectedRoute>
              }
            />
            <Route
              path="/ziyaretci/ayarlar"
              element={
                <ProtectedRoute allowedRoles={['ziyaretci']}>
                  <SettingsPage />
                </ProtectedRoute>
